...
namespace AmtPtpControlPanel
{
        ...
        private void ctlApply_Click(object sender, EventArgs e)
        {
            using (new ButtonWait((Button)sender))
                if (SaveSettings())
                {
                    ...
                    BtDevice.SendIoctl(BtDevice.IOCTL_RELOAD_SETTINGS, false);
                }
        }
    ...
    class BtDevice
    {
        ...
        public static bool SendIoctl(uint code, bool showMessageBox)
        {
            uint dummy;
            return ExecuteIoctl(code, out dummy, false, showMessageBox);
        }

        public static bool SendIoctl(uint code, out uint result, bool showMessageBox)
        {
        ...
        private static bool ExecuteIoctl(uint code, out uint result, bool expectData, bool showMessageBox)
        {
            ...
            finally
            {
                ...
                if (hDevice != null) { hDevice.Dispose(); }
            }
        }
    }
}
